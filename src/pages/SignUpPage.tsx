  ...
  return (
    <div className="space-y-32 py-20">
      ...
      <section className="container mx-auto px-6 max-w-6xl">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold mb-8 elegant-underline">
      ...
      <section className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="max-w-4xl mx-auto text-center mb-12 p-8 rounded-lg bg-black/50">
          <p className="text-2xl text-gray-300 mb-8">
        ...
        <div className="max-w-4xl mx-auto p-8 rounded-lg bg-black/50 mb-10">
          <h3 className="text-3xl font-bold mb-6 text-btb-gold">
            Who This Is For:
          </h3>
          <ul className="text-2xl text-gray-300 list-disc pl-8 space-y-4 mb-8">
        ...
        <div className="max-w-4xl mx-auto text-center mb-12 p-8 rounded-lg bg-black/50">
          ...
          <p className="text-2xl text-gray-300 mb-4">You've seen the value.</p>
          <p className="text-2xl text-gray-300 mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-5xl mx-auto p-8 rounded-lg">
          {[
            {
      ...
      <section id="signup-form" className="container mx-auto px-6 max-w-6xl">
        <motion.div
          initial={{ opacity: 0 }}
